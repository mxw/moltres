...
CREATE USER 'moltres'@'localhost' IDENTIFIED BY 'PUT_YOUR_OWN_PASSWORD_HERE_AND_MAKE_SURE_THOSE_SINGLE_QUOTES_SURROUND_IT'; -- to change password, replace with ALTER USER
